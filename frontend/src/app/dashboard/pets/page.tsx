                ...
                <tbody className="divide-y">
                  {pets.map((pet) => (
                    <tr key={pet.pet_id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 text-black text-sm">{pet.pet_id}</td>
                      <td className="px-6 py-4 text-black text-sm font-medium">{pet.name}</td>
                      <td className="px-6 py-4 text-black text-sm">{pet.species}</td>
                      <td className="px-6 py-4 text-black text-sm">{pet.gender}</td>
                      <td className="px-6 py-4 text-black text-sm">{new Date(pet.dob).toLocaleDateString()}</td>
                      <td className="px-6 py-4 text-black text-sm">{pet.weight} kg</td>
                      <td className="px-6 py-4 text-black text-sm">{pet.owner?.full_name}</td>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:outline-none transition"
            required
          >
